...
void Cboot() {
    ...
    extern int canvas();
    insert_cpred("canvas", 0, canvas);
    extern int line();
    insert_cpred("line", 4, line);
    extern int circle();
    insert_cpred("circle", 4, circle);
    extern int oval();
    insert_cpred("oval", 5, oval);
    extern int arc();
    insert_cpred("arc", 7, arc);
    extern int triangle();
    insert_cpred("triangle", 7, triangle);
    extern int rectangle();
    insert_cpred("rectangle", 5, rectangle);
